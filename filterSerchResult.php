<?php
    ...
    $sql = "SELECT * FROM (SELECT type,location FROM search ORDER BY u_id DESC LIMIT 0,1) as x,post 
            WHERE post.type = x.type OR post.location = x.location"; //using subquery to get the last search
    ...
    if($arr == null){
        echo "<script>alert('No Opportunity Found!')</script>";
                          ...
                          <?php foreach($arr as $arrData){ ?>
                            <div class="col-md-4">
                              <div class="card card-color">
                                <img class="card-img-top" width="240" height="200" src="<?php echo $arrData['featuredImage']?>" alt="Card image cap">
